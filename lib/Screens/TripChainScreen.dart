...
class TripChainScreen extends StatelessWidget {
  // Accept optional trip data to display when navigating from the report screen
  final Map<String, String>? tripData;

  const TripChainScreen({super.key, this.tripData});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // If tripData is provided, show a summary card at the top
            if (tripData != null) ...[
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Saved trip: ${tripData!['trip_number'] ?? ''}',
                      ...
                      Text('Mode: ${tripData!['mode'] ?? ''}'),
                      Text('Time: ${tripData!['time'] ?? ''}'),
                    ],
                  ),
                ),
              ),
